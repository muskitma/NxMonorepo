...
#[derive(Debug)]
pub struct NxMonorepoProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NxMonorepoProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NxMonorepo processing");
    
    let mut processor = NxMonorepoProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NxMonorepoProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NxMonorepoProcessor::new(false);
